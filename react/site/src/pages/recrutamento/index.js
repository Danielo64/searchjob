    ...
    return (
        <Container>
            ...
            <div class="left-and-right-box">
                <div class="left-box">
                    <div class="total-select-box">
                        <div class="select-vaga">
                            <select id="vaga-select" name="vaga-select">
                                <option value="selection">Selecione uma vaga</option>
                                ...
                                <option value="games">Desenvolvedor de Games</option>
                            </select>
                        </div>
